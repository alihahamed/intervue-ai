...
export function PlaceholdersAndVanishInput({
  ...
  const getVoiceButtonLabel = () => {
    ...
    if (voiceState === "processing") return "Processing speech"
  ...
  return (
    <form
      className={cn(
        ...
        value && "bg-gray-50",
        voiceState === "recording" && "ring-2 ring-red-400/50",
      )}
    ...
    >
      ...
      <input
        ...
        type="text"
        className={cn(
          "w-full relative text-sm sm:text-base z-50 border-none dark:text-white bg-transparent text-black h-full rounded-full focus:outline-none focus:ring-0 pl-4 sm:pl-10 pr-24",
      ...
      <button
        ...
        className={cn(
          "absolute right-12 top-1/2 z-50 -translate-y-1/2 h-8 w-8 rounded-full transition duration-200 flex items-center justify-center",
          voiceState === "idle" && "bg-gray-100 dark:bg-zinc-700 hover:bg-gray-200 dark:hover:bg-zinc-600",
          voiceState === "recording" && "bg-red-500",
          voiceState === "processing" && "bg-gray-100 dark:bg-zinc-700",
        )}
      >
        ...
        {/* Recording: White microphone icon */}
        {voiceState === "recording" && (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
        ...
        <AnimatePresence mode="wait">
          {!value && (
            <motion.p
              ...
              key={`current-placeholder-${voiceState}-${currentPlaceholder}`}
